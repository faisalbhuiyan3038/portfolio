    ...
    >
      ...
      <Flex fillWidth maxWidth="xs" gap="16" direction="column">
        ...
        <Flex gap="16" fillWidth>
          <Button data-border="rounded" href={post.metadata.github} variant="tertiary" size="m">
		  ...
		  {post.metadata.live &&
		  (<Button data-border="rounded" href={post.metadata.live} variant="tertiary" size="m">
            <Flex gap="8" alignItems="center">
